    ...
    $.fn.bootstrapDualListbox = function(options) {
        ...
        return this.each(function() {
            ...
            var settings = $.extend( {
                ...
                infotext                : '{0} Options disponibles',// text when all options are visible / false for no info text
                infotextfiltered        : '<span class="label label-warning">Filtre</span> {0} sur {1}',// when not all of the options are visible due to the filter
                infotextempty           : 'Liste Vide',      // when there are no options present in the list
                selectorminimalheight   : 100,
                showfilterinputs        : true
            }, options);

            var container = $('<div class="row-fluid bootstrap-duallistbox-container"><div class="span6 box1"><span class="info-container"><span class="info"></span><button class="btn btn-mini clear1 pull-right">X</button></span><input placeholder="Filtrer" class="filter" type="text"><div class="btn-group buttons"><button class="btn moveall" type="button" title="Déplacer tout"><i class="icon-arrow-right"></i><i class="icon-arrow-right"></i></button><button class="btn move" type="button" title="Deplacer la selection"><i class="icon-arrow-right"></i></button></div><select multiple="multiple" data-duallistbox_generated="true"></select></div><div class="span6 box2"><span class="info-container"><span class="info"></span><button class="btn btn-mini clear2 pull-right">x</button></span><input placeholder="Filtrer" class="filter" type="text"><div class="btn-group buttons"><button class="btn remove" type="button" title="Effacer la selection"><i class="icon-arrow-left"></i></button><button class="btn removeall" type="button" title="Effacer tout"><i class="icon-arrow-left"></i><i class="icon-arrow-left"></i></button></div><select multiple="multiple" data-duallistbox_generated="true"></select></div></div>').insertBefore($(this)),
                elements = {
                    originalselect: $(this),
                    box1: $('.box1', container),
                    box2: $('.box2', container),
